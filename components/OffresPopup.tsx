        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-[#dde5dc] overflow-y-auto max-h-[90vh] animate-scale-in">
          ...
          <div className="bg-gradient-to-r from-[#2d6a4f] to-[#52b788] text-white p-6 text-center relative">
            ...
            <h2 className="font-serif text-2xl font-black mb-2">
              Des offres rien que pour vous
            </h2>
            <p className="text-white/90 text-sm">
              Économisez jusqu'à 15% sur votre permis
            </p>
          </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-center">
                ...
                <div className="font-bold text-[#1a2e22] text-sm">Étudiant</div>
                <div className="text-blue-600 font-bold">-15%</div>
              </div>
              
              {/* Parrainage */}
              <div className="bg-[#2d6a4f]/5 border border-[#2d6a4f]/20 rounded-xl p-4 text-center">
                <Users className="w-6 h-6 text-[#2d6a4f] mx-auto mb-2" />
                <div className="font-bold text-[#1a2e22] text-sm">Parrainage</div>
                <div className="text-[#2d6a4f] font-bold">50€ offerts</div>
              </div>
              
              {/* Famille */}
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-center">
                <Heart className="w-6 h-6 text-amber-500 mx-auto mb-2" />
                <div className="font-bold text-[#1a2e22] text-sm">Famille</div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
                ...
                <div className="font-bold text-[#1a2e22] text-sm">1er coup</div>
            ...
            <div className="text-center">
              <Link
                ...
                className="inline-flex items-center gap-2 bg-[#2d6a4f] hover:bg-[#1b4332] text-white font-bold px-6 py-3 rounded-lg transition-colors w-full justify-center mb-3"
              >
              ...
              <button
                onClick={handleClose}
                className="text-sm text-[#4a5a52] hover:text-[#1a2e22] transition-colors"
              >
                Plus tard
              </button>
            </div>
