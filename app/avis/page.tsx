...
const AVIS = [
  { name: 'Jean B.', date: 'Oct 2023', bg: '#2d6a4f', badge: 'Permis BVM · Moniteur : Seyba', text: "S'il y a une auto-école que je peux conseiller, c'est bien celle-là. Le professionnalisme de Seyba balaie toute anxiété. On sent vraiment qu'il tient à ce que vous réussissiez." },
    ...
    <div className="min-h-screen bg-[#f7f9f5]">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div>
              ...
              <h1 className="font-serif text-4xl sm:text-5xl font-black text-[#1a2e22] mt-2">
            ...
            <div className="bg-white rounded-2xl border border-[#dde5dc] p-6 text-center shadow-sm flex-shrink-0">
              ...
              <p className="text-sm text-[#4a5a52] font-medium">26 avis vérifiés</p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {AVIS.map((a) => (
            <div key={a.name} className="bg-white rounded-2xl border border-[#dde5dc] p-6 flex flex-col card-hover" style={{ borderLeftWidth: 4, borderLeftColor: a.bg }}>
              ...
              <p className="text-sm text-[#4a5a52] italic flex-1 mb-4 leading-relaxed">&ldquo;{a.text}&rdquo;</p>
      ...
      <section className="py-12 px-4 bg-[#eef2ec]">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="font-serif text-3xl font-black text-[#1a2e22] mb-4">À ton tour de rejoindre l&apos;aventure</h2>
