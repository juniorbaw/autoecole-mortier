...
const PLANS = [
  {
    emoji: '📚', title: 'Code Seul', price: '299€', sub: 'Accès illimité en ligne', featured: false,
    features: ['Code en ligne illimité', 'Cours collectifs inclus', 'Suivi personnalisé', 'Inscription examen incluse'],
  },
  {
    emoji: '🚗', title: 'Permis B Manuel', price: '1 099€', sub: 'Forfait 20h de conduite', featured: false,
  ...
  {
    emoji: '⚡', title: 'Permis B Automatique', price: '899€', sub: 'Notre spécialité — forfait 13h', featured: true,
  ...
  {
    emoji: '🚀', title: 'Formule Accélérée', price: '1 399€', sub: 'Code + conduite en 2-4 semaines', featured: false,
...
export default function TarifsPage() {
  return (
    <div className="min-h-screen bg-[#faf9f6]">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {PLANS.map((plan) => (
            <div key={plan.title} className={`relative bg-white rounded-2xl border flex flex-col overflow-hidden card-hover ${plan.featured ? 'border-[#c0451e] shadow-xl' : 'border-[#e7e5e4]'}`}>
              {plan.featured && (
                <div className="absolute top-4 right-4 bg-[#c0451e] text-white text-xs font-bold px-3 py-1 rounded-full">★ SPÉCIALITÉ</div>
              )}
        ...
        <div className="max-w-6xl mx-auto bg-gradient-to-r from-[#16a34a]/10 to-[#16a34a]/5 border border-[#16a34a]/20 rounded-2xl p-8 flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-[#57534e] text-sm">Pour les 15-25 ans. Prêt à taux zéro, ~26€/mois. On monte le dossier avec vous, banque partenaire disponible.</p>
          </div>
      ...
      <section className="py-16 px-4 bg-[#f5f0eb]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <span className="font-mono text-xs text-[#c0451e] font-semibold tracking-widest uppercase">Offres spéciales</span>
            <h2 className="font-serif text-3xl sm:text-4xl font-black text-[#1c1917] mt-2">-15% sur ton permis</h2>
            <p className="text-[#57534e] mt-2">Deux offres exclusives pour payer moins cher</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Offre Étudiants */}
            <div className="bg-white rounded-2xl border border-[#e7e5e4] overflow-hidden shadow-sm">
              <div className="bg-[#f5f0eb] px-6 py-4 border-b border-[#e7e5e4]">
                <span className="text-xs font-bold text-[#c0451e] uppercase tracking-widest">Offre Étudiants</span>
                <h3 className="font-serif text-2xl font-black text-[#1c1917] mt-1">-15% avec ta carte étudiante</h3>
                <p className="text-sm text-[#57534e] mt-1">Carte étudiante ou lycéen valide</p>
              </div>
              <div className="p-6">
                <div className="space-y-3 mb-6">
                  <div className="flex items-center justify-between p-3 bg-[#faf9f6] rounded-xl">
                    <span className="text-sm font-medium text-[#57534e]">Permis B Manuel 20h</span>
                    <div className="text-right">
                      <span className="font-serif font-black text-[#c0451e] text-xl">935€</span>
                      <span className="text-xs text-[#a8a29e] ml-1 line-through">1 099€</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-[#faf9f6] rounded-xl">
                    <span className="text-sm font-medium text-[#57534e]">Permis B Auto 13h</span>
                    <div className="text-right">
                      <span className="font-serif font-black text-[#c0451e] text-xl">765€</span>
                      <span className="text-xs text-[#a8a29e] ml-1 line-through">899€</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-[#faf9f6] rounded-xl">
                    <span className="text-sm font-medium text-[#57534e]">Code Seul</span>
                    <div className="text-right">
                      <span className="font-serif font-black text-[#c0451e] text-xl">255€</span>
                      <span className="text-xs text-[#a8a29e] ml-1 line-through">299€</span>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-xs text-[#a8a29e]">Non cumulable avec l&apos;offre QPV. Heures supp : 60€/h BVM — 65€/h BVA</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-[#3b82f6]/40 overflow-hidden shadow-sm">
              <div className="bg-[#eff6ff] px-6 py-4 border-b border-[#3b82f6]/20">
                ...
                <h3 className="font-serif text-2xl font-black text-[#1c1917] mt-1">-15% pour le 20ème QPV</h3>
                <p className="text-sm text-[#57534e] mt-1">Habitants des quartiers prioritaires du 20ème</p>
              </div>
              <div className="p-6">
                <div className="space-y-3 mb-6">
                ...
                <p className="text-xs text-[#a8a29e] mb-1">Justificatif de domicile en QPV du 20e requis</p>
                <p className="text-xs text-[#a8a29e]">Non cumulable avec l&apos;offre étudiante. Heures supp : 60€/h BVM — 65€/h BVA</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-[#faf9f6]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <span className="font-mono text-xs text-[#c0451e] font-semibold tracking-widest uppercase">Financement</span>
            <h2 className="font-serif text-3xl font-black text-[#1c1917] mt-2">Aides disponibles en 2026</h2>
            <p className="text-[#57534e] mt-2">Jusqu&apos;à 0€ de reste à charge !</p>
          </div>

          <div className="bg-white rounded-2xl border border-[#e7e5e4] overflow-hidden mb-6">
            {AIDES.map((aide, i) => (
              <div key={aide.label} className={`flex items-center justify-between px-6 py-4 ${i < AIDES.length - 1 ? 'border-b border-[#f5f0eb]' : ''}`}>
                <span className="text-sm text-[#57534e]">{aide.label}</span>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 flex items-start gap-4">
            ...
            <div>
              <p className="font-semibold text-amber-800 text-sm mb-1">⚠️ Aides récemment supprimées</p>
      ...
      {/* Parrainage */}
      <section className="py-16 px-4 bg-[#1a1814]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <span className="font-mono text-xs text-[#c0451e] font-semibold tracking-widest uppercase">Parrainage Double Bonus</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <p className="text-xs font-bold text-[#c0451e] uppercase tracking-widest mb-3">CE QUE TU REÇOIS</p>
              ...
              <div className="bg-[#c0451e]/20 border border-[#c0451e]/30 rounded-xl px-4 py-2 inline-block">
                <span className="text-[#c0451e] font-bold text-sm">Valeur totale : jusqu&apos;à 110€ d&apos;avantage</span>
              </div>
            </div>

            {/* Ce que ton ami reçoit */}
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <p className="text-xs font-bold text-[#c0451e] uppercase tracking-widest mb-3">CE QUE TON AMI REÇOIT</p>
          ...
          <div className="bg-white/5 border border-[#c0451e]/30 rounded-2xl p-6">
            <p className="text-xs font-bold text-[#c0451e] uppercase tracking-widest mb-5 text-center">SUPER PARRAIN — PALIERS</p>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-white/80 font-medium">3 amis inscrits</span>
                <div className="text-right">
                  <span className="font-bold text-[#c0451e]">+1h conduite gratuite</span>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <span className="font-bold text-[#c0451e]">+2h conduite gratuites</span>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <span className="font-bold text-[#c0451e]">Conversion BVA→BVM OFFERTE</span>
          ...
          <p className="text-center text-white/40 text-sm mt-6">Pour obtenir ton code parrain, demande à Oumy — <a href="tel:0182833126" className="text-[#c0451e] hover:underline">01 82 83 31 26</a></p>
        </div>
      </section>
