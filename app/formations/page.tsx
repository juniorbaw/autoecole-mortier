...
const FORMATIONS = [
  ...
  { Icon: Repeat,     tag: 'Passerelle', tagColor: 'bg-orange-100 text-orange-700', title: 'Passerelle BVA→BVM', price: '350€', sub: 'Passer de l\'automatique au manuel', features: ['7h de conduite minimum', 'Examen pratique uniquement', 'Rapide et efficace', 'Moniteurs experts', 'Flexibilité des créneaux', 'Attestation officielle'] },
