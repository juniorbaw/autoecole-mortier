...
const FORMATIONS = [
  { Icon: Car,        tag: 'Best-seller', tagColor: 'bg-[#2d6a4f]/10 text-[#2d6a4f]', title: 'Permis B Manuel', price: '1 099€', sub: 'au lieu de 1 290€ — Économie de 191€', features: ['Code de la route inclus', '20h de conduite minimum', 'Accompagnement à l\'examen', 'Finançable CPF', 'Compatible permis 1€/jour', 'Moniteurs certifiés'] },
  { Icon: Zap,        tag: 'Spécialité', tagColor: 'bg-blue-100 text-blue-700', title: 'Permis B Automatique', price: '899€', sub: 'Notre spécialité — 13h minimum', features: ['Code de la route inclus', '13h de conduite minimum', 'Plus accessible', 'Idéal mobilité urbaine', 'Finançable CPF', 'Compatible permis 1€/jour'] },
  { Icon: Rocket,     tag: 'Express', tagColor: 'bg-indigo-100 text-indigo-700', title: 'Formule Accélérée', price: '1 399€', sub: 'au lieu de 1 590€ — Économie de 191€', features: ['Stage code 3 jours', 'Conduite quotidienne intensive', 'Date examen prioritaire', 'Finançable CPF', 'Résultat en 2-4 semaines', 'Suivi personnalisé'] },
  ...
  { Icon: Repeat,     tag: 'Conversion', tagColor: 'bg-orange-100 text-orange-700', title: 'Conversion BVA→BVM', price: '350€', sub: 'Passer de l\'automatique au manuel', features: ['7h de conduite minimum', 'Examen pratique uniquement', 'Rapide et efficace', 'Moniteurs experts', 'Flexibilité des créneaux', 'Attestation officielle'] },
  { Icon: Smartphone, tag: 'En ligne', tagColor: 'bg-purple-100 text-purple-700', title: 'Code en Ligne', price: '299€', sub: 'au lieu de 350€ — Économie de 51€', features: ['Accès illimité en ligne', 'Cours collectifs inclus', 'Suivi personnalisé', 'Inscription examen incluse', 'Compatible mobile', 'Disponible 24h/24'] },
