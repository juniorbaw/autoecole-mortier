...
function CellValue({ val }: { val: unknown }) {
  ...
  return <span className="text-xs text-[#57534e] font-medium">{val as string}</span>
}
    ...
    <div className="min-h-screen bg-[#faf9f6]">
      ...
      <section className="py-20 px-4 bg-[#f5f0eb]">
        <div className="max-w-7xl mx-auto text-center">
          <span className="font-mono text-xs text-[#c0451e] font-semibold tracking-widest uppercase">Pourquoi nous</span>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-serif text-2xl font-black text-[#1c1917] mb-8">Comparatif concurrentiel</h2>
          <div className="overflow-x-auto rounded-2xl border border-[#e7e5e4] shadow-sm">
            <table className="w-full bg-white text-sm">
              <thead>
                <tr className="border-b border-[#e7e5e4]">
                  <th className="text-left p-4 text-[#57534e] font-semibold">Critère</th>
                  <th className="p-4 bg-[#c0451e]/5 text-[#c0451e] font-bold">🏆 Mortier</th>
                  <th className="p-4 text-[#57534e] font-semibold">Saint-Fargeau</th>
                  <th className="p-4 text-[#57534e] font-semibold">CER P. des Lilas</th>
                  <th className="p-4 text-[#57534e] font-semibold">Ornikar</th>
                  <th className="p-4 text-[#57534e] font-semibold">Gambetta Permis</th>
                </tr>
              </thead>
              <tbody>
                {COMPARATIF.map((row, i) => (
                  <tr key={row.critere} className={`border-b border-[#e7e5e4] ${i % 2 === 0 ? '' : 'bg-[#faf9f6]'}`}>
                    <td className="p-4 font-medium text-[#1c1917]">{row.critere}</td>
                    <td className="p-4 bg-[#c0451e]/5 text-center font-bold text-[#c0451e]"><CellValue val={row.mortier} /></td>
          ...
          <p className="text-xs text-[#a8a29e] mt-3">*Ornikar n&apos;a pas d&apos;agence — accompagnement limité.</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-[#f5f0eb]">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="bg-white rounded-2xl border border-[#e7e5e4] p-8">
            <h3 className="font-serif text-xl font-black text-[#1c1917] mb-6">Satisfaction client (note /5)</h3>
            <AnimatedBar label="🏆 Auto-école Mortier" value={5.0} max={5} color="#c0451e" suffix="/5" />
          ...
          <div className="bg-white rounded-2xl border border-[#e7e5e4] p-8">
            <h3 className="font-serif text-xl font-black text-[#1c1917] mb-6">Prix forfait 20h BVM (€)</h3>
            <AnimatedBar label="🏆 Mortier" value={1099} max={1500} color="#c0451e" suffix="€" />
            ...
            <p className="text-xs text-[#a8a29e] mt-2">*sans agence physique</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="font-serif text-3xl font-black text-[#1c1917] mb-4">Convaincu ?</h2>
          <p className="text-[#57534e] mb-6">Appelez Oumy pour une évaluation gratuite et sans engagement.</p>
          <a href="tel:0182833126" className="inline-flex items-center gap-2 bg-[#c0451e] hover:bg-[#a83a18] text-white font-bold px-8 py-4 rounded-xl transition-colors text-lg">
